...
onnx_model_dict |= {
    ...
    "sig_bkg_dnn": "/work/bevila_t/PostDoc/HH4b/Output/ML_trainings/SPANet_classification/ZZ_ZH_HH_QCD_classification_two_tiers_v2/out_HH_ZH_ZZ_DATA_classification_step_2_phaseB_continued_v2/version_0/out_HH_ZH_ZZ_2b_DATA_classification_only_v2_step2_phaseB_continued_2.onnx",
}
...
config_options_dict |= {
    "dnn_variables": True,
    "run2": False,
    "sig_bkg_dnn_input_variables": dnn_vars.sig_bkg_dnn_multiclass_input_variables,
    ...
    "save_spanet_input_variables": False,
    "fifth_jet": "pt",
    "pad_value": -999.0,
    "add_jet_spanet": True,
    "spanet_input_name": dnn_vars.pairing_spanet_btagWP5,
    "max_num_jets_higgs_pairing": 5,
    "max_num_jets_spanet_class": 7,
    "max_num_jets_good": 4,
    "which_bquark": "last",
    "qt_postEE": None,
    "qt_postBPix": "/work/bevila_t/PostDoc/HH4b/Output/PocketCoffea/ggF_vbf_ZZ_ZH_data_parkingHH_vbf_spanet_bkg_rwg_SvB_2023_postBPix/quantile_transformer/SRSpanet_qt/qt_events_sig_bkg_dnn_score_kl_1.00.pkl",
    "random_pt": False,
    "rand_type": 0.3,
    # VBF
